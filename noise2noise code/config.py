...
datasets = {
    'kodak':  dnnlib.EasyDict(dataset_dir='/home/shibin2/projects/def-ajbonner/shibin2/code/n2n/datasets/kodak'),
...
#    noise=poisson_noise_config,
    noise2noise=True,
    train_tfrecords='datasets/train.tfrecords',
    ...
    def train(args):
        if args:
            ...
            if 'long_train' in args and args.long_train:
                train_config.iteration_count = 300000
                train_config.eval_interval = 40000
